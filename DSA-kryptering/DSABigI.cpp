...
void clearWBuffert(uint32*);
uint32 leftrotate(uint32, uint32);
void transform(uint32*, uint32*);
void sha1(const char*);

int bitLength(BigUnsigned);
BigUnsigned random_number(int);
BigUnsigned random_number_seed(unsigned int);
BigUnsigned random_number_seed_limit(unsigned int, unsigned int);
bool is_prime(BigUnsigned, int);
BigUnsigned random_prime(unsigned int, unsigned int);
void keyGenerating(unsigned int, unsigned int, unsigned int);
void userKeys(BigUnsigned, BigUnsigned, BigUnsigned, unsigned int);
void signing(string, unsigned int);
void verifying(string);

/**
 * The main functions take input from the user and starts the choosen prosses.
 */
int main(){
...
/**
 * The transform function to sha1, each chunk goes throu here.
 */
...
/**
 * The function for signing a file or message.
 */
...
/**
 * The function for verifying the file or message
 */
...
/**
 * The function for private and public key.
 */
...
/**
 * Counts the bit length of a number
 */
